...
class FeatureContext extends BehatContext implements ClosuredContextInterface {
	...
	public static function prepare( SuiteEvent $event ) {
		...
		$wp_version_suffix = ( $wp_version = getenv( 'WP_VERSION' ) ) ? "-$wp_version" : '';	$wp_version_suffix = ( $wp_version = getenv( 'WP_VERSION' ) ) ? "-$wp_version" : '';
	...
	public function install_wp( $subdir = '' ) {
		...
		$url = empty( $subdir ) ? 'http://example.com' : 'http://' . $subdir . '.com';
		$install_args = array(
			'url' => $url,
			'title' => 'WP CLI Site',
			'admin_user' => 'admin',
